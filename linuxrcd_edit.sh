...
find "/media/LiveDiskCreAtionChrootFolDer" -type f   -not -path "/media/LiveDiskCreAtionChrootFolDer/proc/*" -not -path "/media/LiveDiskCreAtionChrootFolDer/sys/*" -not -path "/media/LiveDiskCreAtionChrootFolDer/dev/*" -not -path "/media/LiveDiskCreAtionChrootFolDer/tmp/*" -not -path "/media/LiveDiskCreAtionChrootFolDer/usr/bin/recoverylauncher" -not -path "/media/LiveDiskCreAtionChrootFolDer/usr/launchers/Apps" | sort -r | while read FILE
do
